...
TEST_F(Fixture, IsCRCOk_WhenTypical)
{
    bool expected{true};
    bool actual{false};
    uint8_t data[kPageSize + kSizeOfCRC32 + kSizeOfDestinationAddress]{0x7e, 0x8a, 0x8b, 0xeb, 0x77, 0x7b, 0xa9, 0xd0, 0x80, 0x36, 0x10, 0x8c, 0xd4, 0x79, 0x1b, 0x50,
    ...
    actual = sut_.isCrcOk(data, sizeof(data), 0xBCA8D80A);

    ASSERT_EQ(actual, expected);
}

TEST_F(Fixture, IsCRCNotOk_WhenTypical)
{
    bool expected{false};
    bool actual{false};
    uint8_t data[kPageSize + kSizeOfCRC32 + kSizeOfDestinationAddress]{0xAA, 0x8a, 0x8b, 0xeb, 0x77, 0x7b, 0xa9, 0xd0, 0x80, 0x36, 0x10, 0x8c, 0xd4, 0x79, 0x1b, 0x50,
                                                                       0x96, 0x45, 0x11, 0xef, 0x8f, 0x26, 0xdc, 0xc6, 0xa8, 0x88, 0x01, 0x09, 0xd8, 0x71, 0xf1, 0x6f,
                                                                       0xfa, 0x70, 0x50, 0x10, 0x60, 0x69, 0xb9, 0xd6, 0xa1, 0xad, 0x12, 0xf9, 0x6e, 0x20, 0x1a, 0x4d,
                                                                       0x9e, 0xff, 0xa0, 0x26, 0x58, 0x79, 0xae, 0x7f, 0x5e, 0xf8, 0x20, 0x69, 0xa2, 0x35, 0xb6, 0x38,
                                                                       0x9a, 0xb1, 0xc2, 0x12, 0x1f, 0xdd, 0x50, 0x5d, 0x25, 0xd3, 0xd6, 0x16, 0x5c, 0xf8, 0x46, 0x02,
